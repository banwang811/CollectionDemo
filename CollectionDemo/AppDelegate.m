...
#import "BWViewController1.h"
#import "BWViewController2.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *controller1 = [[UINavigationController alloc] initWithRootViewController:[BWViewController1 new]];
    controller1.title = @"controller1";
    UINavigationController *controller2 = [[UINavigationController alloc] initWithRootViewController:[BWViewController2 new]];
